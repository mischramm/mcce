...
\input{thesis_chapters/02_relatedWork/_main}
\input{thesis_chapters/03_fundamentals/_main}
\input{thesis_chapters/04_methodology/_main}
\input{thesis_chapters/05_empiricalWork/_main}
\input{thesis_chapters/06_interpretationAndDiscussionOfResults/_main}
\input{thesis_chapters/07_conclusion/_main}
%\input{thesis_chapters/08_references} % don't need this, as we use biblatex
